...
INTERNAL=github.com/Swarup012/solo/cmd/octa/internal
...
OCTA_HOME?=$(HOME)/.octa
WORKSPACE_DIR?=$(OCTA_HOME)/workspace
...
## build: Build the octa binary for current platform
build: generate
...
## build-all: Build octa for all platforms
build-all: generate
	@echo "Building for multiple platforms..."
	@mkdir -p $(BUILD_DIR)
...
## install: Install octa to system and copy builtin skills
install: build
...
## uninstall: Remove octa from system
uninstall:
...
## uninstall-all: Remove octa and all data
uninstall-all:
	@echo "Removing workspace and skills..."
	@rm -rf $(OCTA_HOME)
	@echo "Removed workspace: $(OCTA_HOME)"
...
help:
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.octa/workspace)"
