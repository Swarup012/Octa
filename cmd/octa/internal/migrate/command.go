...
import (
	...
	"github.com/Swarup012/solo/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from xxxclaw(openclaw, etc.) to octa",
		Args:  cobra.NoArgs,
		Example: `  octa migrate
  octa migrate --from openclaw
  octa migrate --dry-run
  octa migrate --refresh
  octa migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.octa)")
