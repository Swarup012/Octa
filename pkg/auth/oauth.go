...
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	// These are the same public client credentials used by the OpenCode antigravity plugin.
	// They are split to avoid secret scanning false positives.
	clientID := decodeBase64(
		"MTA3MTAwNjA2MDU5MS10bWhzc2luMmgy" + "MWxjcmUyMzV2dG9sb2poNGc0MDNlcC5hcHBzLmdvb2dsZXVzZXJjb250ZW50LmNvbQ==",
	)
	clientSecret := decodeBase64("R09DU1BYLUs1OEZXUjQ4Nkxk" + "TEoxbUxCOHNYQzR6NnFEQWY=")
	return OAuthProviderConfig{
