...
import (
	...
	anthropicprovider "github.com/Swarup012/solo/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: octa auth login --provider anthropic")
		}
