...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.octa")
	assert.Equal(t, "/home/user/.octa/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.octa/workspace/file.txt", "/home/user/.octa")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".octa"), result)
}
